...
export class productsPage{
    ...
    constructor(page: Page){
        ...
        this.productList=page.locator('div.inventory_item');
    ...
    public async validateDetail(prodName :  string){
        await expect(await this.page.getByText(prodName)).toHaveCount(1);
